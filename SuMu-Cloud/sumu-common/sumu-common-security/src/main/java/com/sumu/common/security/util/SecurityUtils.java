...
package com.sumu.common.security.util;
...
public class SecurityUtils {
	 ...
	 * 获取用户
	 */
	public SuMuUser getUser(Authentication authentication) {
		Object principal = authentication.getPrincipal();
		if (principal instanceof SuMuUser) {
			return (SuMuUser) principal;
		}
		return null;
	}

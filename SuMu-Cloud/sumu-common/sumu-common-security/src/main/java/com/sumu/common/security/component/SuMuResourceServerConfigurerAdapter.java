 ...
 */
@Slf4j
public class SuMuResourceServerConfigurerAdapter extends ResourceServerConfigurerAdapter {
	...
	@Autowired
	private SuMuBearerTokenExtractor pigBearerTokenExtractor;
	...
	public void configure(ResourceServerSecurityConfigurer resources) {
		...
		UserAuthenticationConverter userTokenConverter = new SuMuUserAuthenticationConverter();

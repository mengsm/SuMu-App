...
import com.sumu.common.security.exception.*;
 ...
 */
@Slf4j
public class SuMuWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
	...
	private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) {
		...
		return new ResponseEntity<>(new SuMuAuth2Exception(e.getMessage(), e.getOAuth2ErrorCode()), headers,

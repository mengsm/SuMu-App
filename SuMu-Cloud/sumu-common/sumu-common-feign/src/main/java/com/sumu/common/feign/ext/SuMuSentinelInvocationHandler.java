 ...
 */
@Slf4j
public class SuMuSentinelInvocationHandler implements InvocationHandler {
	...
	SuMuSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			SuMuSentinelInvocationHandler other = (SuMuSentinelInvocationHandler) obj;
